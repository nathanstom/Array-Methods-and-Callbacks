...
function getYears(fifaData, getFinalscb) {
    ...
    const years = getFinalscb(fifaData).map(function(game){
...
function getWinners(fifaData, getFinalscb) {
    const winners = [];
getFinalscb(fifaData).forEach(function(win){
    if(win ['Home Team Goals'] > win ['Away Team Goals']){
        winners.push(win['Home Team Name'])
    }else{
        winners.push(win['Away Team Name'])
    }
